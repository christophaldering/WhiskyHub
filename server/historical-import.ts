      ...
      if (dryRun) {
        ...
        for (const row of rows) {
          ...
          const entryData: InsertHistoricalTastingEntry = {
            ...
            normalizedNose: row.noseScore != null ? row.noseScore * 10 : null,
            normalizedTaste: row.tasteScore != null ? row.tasteScore * 10 : null,
            normalizedFinish: row.finishScore != null ? row.finishScore * 10 : null,
