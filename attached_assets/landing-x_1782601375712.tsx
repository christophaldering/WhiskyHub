  ...
  return (
    <header style={{ position: "sticky", top: 0, zIndex: 100, background: v.bg, borderBottom: `1px solid ${v.border}`, padding: "14px 24px", display: "flex", justifyContent: "space-between", alignItems: "center", gap: 16, flexWrap: "wrap" }} data-testid="header-nav">
      <div style={{ display: "flex", alignItems: "center", gap: 22 }}>
        ...
        <a href="/tour" data-testid="link-header-tour" style={{ fontFamily: font.body, fontSize: 14, fontWeight: 500, color: v.text, textDecoration: "none", letterSpacing: "0.01em" }}>{isDE ? "Funktionen" : "Features"}</a>
      </div>
...
function HeroSection() {
  ...
  return (
    <section style={{ display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", textAlign: "center", position: "relative", overflow: "hidden", padding: "72px 24px 88px" }} data-testid="section-hero">
      ...
      <FadeUp delay={0.5}>
        <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 12, maxWidth: 330, margin: "0 auto", marginBottom: 16, position: "relative", zIndex: 2 }}>
          <Link href="/labs/tastings?tab=solo" data-testid="cta-hero-solo" style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: 9, width: "100%", padding: "16px 36px", background: `${ACCENT}10`, color: v.text, fontFamily: font.body, fontSize: 15, fontWeight: 600, borderRadius: 50, border: `1.5px solid ${ACCENT}55`, textDecoration: "none", letterSpacing: "0.01em" }}>
            <Wine style={{ width: 17, height: 17, color: ACCENT }} />{tx("Solo verkosten", "Taste solo")}
          </Link>
          <Link href="/labs/tastings?tab=join" data-testid="cta-hero-join" style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: 9, width: "100%", padding: "16px 36px", background: `${ACCENT}10`, color: v.text, fontFamily: font.body, fontSize: 15, fontWeight: 600, borderRadius: 50, border: `1.5px solid ${ACCENT}55`, textDecoration: "none", letterSpacing: "0.01em" }}>
            <Users style={{ width: 17, height: 17, color: ACCENT }} />{tx("Einem Tasting beitreten", "Join a tasting")}
          </Link>
          <a href="/tour" data-testid="link-hero-tour" style={{ display: "inline-flex", alignItems: "center", gap: 6, marginTop: 4, fontFamily: font.body, fontSize: 14, fontWeight: 500, color: ACCENT, textDecoration: "none", letterSpacing: "0.01em" }}>
            {tx("Alle Funktionen ansehen", "See all features")} <ArrowRight style={{ width: 15, height: 15 }} />
          </a>
        </div>
      </FadeUp>
      <FadeUp delay={0.6}>
  ...
  return (
    <section style={{ padding: "40px 24px 88px" }} data-testid="section-stance">
      <div style={{ ...container, maxWidth: 600, textAlign: "center" }}>
        ...
        <FadeUp delay={0.2}>
          <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 12, maxWidth: 330, margin: "0 auto" }}>
            <Link href="/labs/tastings?tab=solo" data-testid="cta-footer-solo" style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: 9, width: "100%", padding: "15px 34px", background: `${ACCENT}10`, color: v.text, fontFamily: font.body, fontSize: 15, fontWeight: 600, borderRadius: 50, border: `1.5px solid ${ACCENT}55`, textDecoration: "none", letterSpacing: "0.01em" }}>
              <Wine style={{ width: 17, height: 17, color: ACCENT }} />{tx("Solo verkosten", "Taste solo")}
            </Link>
            <Link href="/labs/tastings?tab=join" data-testid="cta-footer-join" style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: 9, width: "100%", padding: "15px 34px", background: `${ACCENT}10`, color: v.text, fontFamily: font.body, fontSize: 15, fontWeight: 600, borderRadius: 50, border: `1.5px solid ${ACCENT}55`, textDecoration: "none", letterSpacing: "0.01em" }}>
              <Users style={{ width: 17, height: 17, color: ACCENT }} />{tx("Einem Tasting beitreten", "Join a tasting")}
            </Link>
          </div>
        </FadeUp>
        <FadeUp delay={0.32}>
          <div style={{ marginTop: 48, paddingTop: 38, borderTop: `1px solid ${v.border}`, display: "flex", gap: 14, alignItems: "center", justifyContent: "center", flexWrap: "wrap" }}>
            <a
              href="/tour"
              data-testid="cta-footer-tour"
            ...
            >
              ...
              {tx("Was kann CaskSense?", "What can CaskSense do?")}
            </a>
            <Link
              href="/labs/about"
