...
const DE: Translations = {
  ...
  soloSaved: 'Im Diary gespeichert', soloAnother: 'Weiteren Dram erfassen →', soloToHub: 'Zurück',
  ...
  mwJournalTitle: 'Diary', mwJournalSub: 'Alle deine Drams', mwJournalSearch: 'Suche...', mwJournalEmpty: 'Noch keine Drams im Diary.',
...
const EN: Translations = {
  ...
  soloSaved: 'Saved to diary', soloAnother: 'Log another dram →', soloToHub: 'Back',
  ...
  mwJournalTitle: 'Diary', mwJournalSub: 'All your drams', mwJournalSearch: 'Search...', mwJournalEmpty: 'No drams in diary yet.',
