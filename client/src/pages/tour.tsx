...
const slides: SlideData[] = [
  ...
  },
  {
    ...
    subtitle: "Whiskys ohne Vorurteile verkosten. Der Gastgeber steuert die Enthüllung — dramatisch, Flasche für Flasche.",
    image: slideBlind,
    badge: "Highlight",
    layout: "left",
    features: [
      { icon: EyeOff, title: "Blind-Modus", desc: "Etiketten ausblenden, Namen verbergen, fair bewerten" },
      { icon: Eye, title: "Schrittweise Enthüllung", desc: "Gastgeber enthüllt nach und nach — mit Diagrammen und Bewertungen" },
      { icon: Sparkles, title: "ABV & Alter raten", desc: "Zusätzliche Herausforderung für erfahrene Gaumen" },
      { icon: Camera, title: "Cover-Bild Enthüllung", desc: "Gruppen- oder Sessionfoto als Überraschungsmoment" },
    ],
  },
  {
    type: "content",
    ...
    features: [
      ...
      { icon: Brain, title: "Benchmark-Analyse", desc: "Bewertungen hochladen, KI extrahiert Punkte und Notizen" },
  ...
  },
  {
    ...
    layout: "left",
    features: [
      { icon: LayoutDashboard, title: "Verkostungsbrett", desc: "Alle Whiskys auf einen Blick — nummeriert und sortiert" },
  ...
  },
  {
    ...
    layout: "right",
    features: [
      { icon: Activity, title: "Geschmacksprofil", desc: "Radar-Diagramm deiner Vorlieben: Region, Fass, Torfgehalt" },
      { icon: Sparkles, title: "Aromenrad", desc: "Sunburst-Diagramm mit 8 Kategorien deiner Aromen" },
      { icon: NotebookPen, title: "Whisky-Tagebuch", desc: "Notizen, Fotos, Stimmung — deine persönliche Bibliothek" },
      { icon: Trophy, title: "37 Abzeichen", desc: "Von der ersten Bewertung bis zum 1.000sten Tasting" },
      { icon: GitCompareArrows, title: "Direktvergleich", desc: "2–3 Whiskys nebeneinander vergleichen" },
  ...
  },
  {
    ...
    subtitle: "Whisky-Freunde finden, Aktivitäten verfolgen, Ranglisten vergleichen — Whisky macht am Tisch mehr Sinn.",
    ...
    features: [
      ...
      { icon: Trophy, title: "Rangliste", desc: "Wertungen: aktivster Bewerter, detaillierteste Notizen" },
  ...
  },
  {
    ...
    layout: "left",
    features: [
      { icon: LayoutDashboard, title: "Gastgeber-Übersicht", desc: "Tastings, Teilnehmer, Durchschnittsbewertungen im Blick" },
      { icon: FileDown, title: "Tasting-Zusammenfassung", desc: "Rückblick zum Teilen: Top-Whisky, Kontroversen" },
      { icon: Users, title: "Gastgeber-Delegation", desc: "Gastgeber-Rolle an anderen Teilnehmer übertragen" },
  ...
  },
  {
    ...
    subtitle: "Live-Moderation mit geteiltem Bildschirm für den Gastgeber und Vollbild-Ansicht für die Teilnehmer.",
    image: slideGuided,
    badge: "Präsentation",
    layout: "right",
    features: [
      { icon: LayoutDashboard, title: "Geteilter Bildschirm", desc: "Steuerung links, Präsentation rechts — alles im Blick" },
      { icon: Eye, title: "Vollbild Teilnehmer", desc: "Große, klare Darstellung auf Bildschirm oder Beamer" },
      { icon: Sparkles, title: "Schrittweise Enthüllung", desc: "Nach und nach enthüllen mit Animationen und Diagrammen" },
      { icon: Star, title: "Automatische Aktivierung", desc: "Präsentationsmodus startet mit der Enthüllungsphase" },
    ],
  },
  {
    type: "content",
