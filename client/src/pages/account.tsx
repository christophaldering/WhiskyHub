...
import { Mail, KeyRound, Download, RotateCcw, Trash2, AlertTriangle, UserCog } from "lucide-react";
...
export default function Account() {
  ...
  if (!currentParticipant) {
    return (
      <PageLayout icon={UserCog} title={t("account.title")} variant="narrow" testId="page-account">
  ...
  return (
    <PageLayout icon={UserCog} title={t("account.title")} subtitle={t("account.subtitle")} variant="narrow" testId="page-account">
