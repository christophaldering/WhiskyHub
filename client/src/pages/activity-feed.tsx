...
export default function ActivityFeed() {
  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-8" data-testid="activity-feed-page">
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
        <div className="flex items-center gap-3 mb-2">
          <Rss className="w-7 h-7 text-primary" />
          <h1 className="text-2xl md:text-3xl font-serif font-bold text-primary" data-testid="text-feed-title">
