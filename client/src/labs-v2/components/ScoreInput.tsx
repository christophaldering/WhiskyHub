...
export default function ScoreInput({ value, onChange, phaseId, th, t }: ScoreInputProps) {
    ...
    <div data-testid={`score-input-${phaseId}`}>
      ...
      >
        ...
        <div style={{
          ...
          borderRadius: 3,
          width: `${pct}%`,
          background: `linear-gradient(90deg, ${phase.accent}, ${phase.accent})`,
        }} />
        <div
