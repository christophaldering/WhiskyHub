...
export function SortAZ(p: IconProps) {
  return svg(p, "0 0 24 24", <>
    <path d="M3 6h7" />
    <path d="M3 12h5" />
    <path d="M3 18h3" />
...
export function StarIcon(p: IconProps) {
  return (
    <svg width={p.size ?? 24} height={p.size ?? 24} viewBox="0 0 24 24" fill={p.color} stroke={p.color} strokeWidth={1.8} strokeLinecap="round" strokeLinejoin="round" style={p.style}>
