  ...
  en: {
    translation: {
      ...
      landing: {
        ...
        hero: {
          badge: "Smart Whisky Tastings",
          title: "Discover Whisky Together",
          subtitle: "Host collaborative blind tastings, capture every nuance with AI-powered tools, and build your personal whisky journey — no expertise required.",
        ...
        stats: {
          ...
          participants: "Tasters Joined",
          whiskies: "Whiskies Rated",
          ratings: "Ratings Given",
        },
        features: {
          title: "Everything You Need for Whisky Tastings",
          subtitle: "From organising your session to analysing results — CaskSense covers the full tasting experience.",
          blindTasting: "Blind Tastings",
          blindTastingDesc: "Run structured blind sessions with hidden labels and a dramatic multi-act reveal. Fair, fun, and bias-free.",
          aiImport: "AI-Powered Import",
          aiImportDesc: "Upload photos, spreadsheets, or paste text — our AI extracts whisky details automatically. No manual data entry.",
          journal: "Whisky Journal",
          journalDesc: "Keep a personal tasting diary with notes, photos, and ratings. Your whisky journey, beautifully documented.",
          analytics: "Rich Analytics",
          analyticsDesc: "Explore radar charts, flavor profiles, regional breakdowns, and side-by-side comparisons across all your tastings.",
          community: "Social Tastings",
          communityDesc: "Invite friends with a code or QR link, share ratings, and compare palates. Whisky is better together.",
          encyclopedia: "Knowledge Base",
          encyclopediaDesc: "Discover distilleries, regions, and bottlers with our built-in encyclopedia. Research while you taste.",
        },
        howItWorks: {
          title: "Three Simple Steps",
          subtitle: "From set-up to sipping in under a minute.",
        },
        steps: {
          create: "Create a Tasting",
          createDesc: "Give your session a name and add whiskies — manually, from a spreadsheet, or let AI do it for you.",
          invite: "Invite Your Friends",
          inviteDesc: "Share an access code or QR link. Guests join instantly — no account required.",
          taste: "Taste & Discover",
          tasteDesc: "Rate, discuss, and reveal results together. Compare palates and explore what you love.",
        },
        story: {
          title: "The Story Behind CaskSense",
          label: "Our Journey",
          p1: "CaskSense was born from a simple passion: sharing great whisky with friends and wanting to remember every dram. What started as scribbled notes on napkins grew into the desire for a proper tool — one that captures the full experience, not just the score.",
          p2: "We believe whisky tastings should be accessible, social, and a little bit magical. That's why we built blind tasting support, AI-powered imports, and a reveal system that turns every session into an event worth remembering.",
          p3: "Whether you're a seasoned collector or opening your first bottle of single malt, CaskSense is designed to make every sip count. We're whisky lovers building for whisky lovers.",
        },
        ai: {
          badge: "Powered by AI",
          title: "Import Tastings From Anything",
          desc: "No more typing whisky names by hand. Snap a photo of your bottles, upload a spreadsheet, paste a website URL, or type a list — CaskSense's AI extracts all the details in seconds.",
          bullet1: "Photo recognition: just photograph your lineup",
          bullet2: "Excel & CSV import with automatic column mapping",
          bullet3: "Paste text or URLs and let AI do the rest",
          photo: "Photos",
          file: "Spreadsheets",
          web: "URLs & Text",
          text: "Tasting Lists",
        ...
        cta: {
          title: "Ready to Elevate Your Tastings?",
          desc: "Join the CaskSense community and start hosting better whisky experiences today. Free to use, no account needed to get started.",
          button: "Enter CaskSense",
        },
        footer: {
          about: "About",
          features: "Features",
  ...
  de: {
    translation: {
      ...
      landing: {
        ...
        hero: {
          badge: "Smarte Whisky-Verkostungen",
          title: "Whisky gemeinsam entdecken",
          subtitle: "Veranstalte gemeinsame Blind-Tastings, erfasse jede Nuance mit KI-Tools und gestalte deine persönliche Whisky-Reise — keine Vorkenntnisse nötig.",
          cta: "Erstes Tasting starten",
          learnMore: "Mehr erfahren",
          avgRating: "Durchschnittsnote",
        },
        stats: {
          tastings: "Tastings veranstaltet",
          participants: "Teilnehmer dabei",
          whiskies: "Whiskys bewertet",
          ratings: "Bewertungen abgegeben",
        },
        features: {
          title: "Alles für dein Whisky-Tasting",
          subtitle: "Von der Organisation bis zur Auswertung — CaskSense begleitet das komplette Tasting-Erlebnis.",
          blindTasting: "Blind Tastings",
          blindTastingDesc: "Führe strukturierte Blind-Sessions mit verdeckten Etiketten und einer dramatischen Enthüllung in mehreren Akten durch. Fair, spaßig und vorurteilsfrei.",
          aiImport: "KI-Import",
          aiImportDesc: "Lade Fotos, Tabellen hoch oder füge Text ein — unsere KI extrahiert Whisky-Details automatisch. Keine manuelle Dateneingabe.",
          journal: "Whisky-Tagebuch",
          journalDesc: "Führe ein persönliches Tasting-Tagebuch mit Notizen, Fotos und Bewertungen. Deine Whisky-Reise, wunderschön dokumentiert.",
          analytics: "Umfangreiche Analysen",
          analyticsDesc: "Erkunde Radar-Charts, Geschmacksprofile, regionale Aufschlüsselungen und Seite-an-Seite-Vergleiche über alle deine Tastings.",
          community: "Soziale Tastings",
          communityDesc: "Lade Freunde per Code oder QR-Link ein, teile Bewertungen und vergleiche Gaumen. Whisky ist gemeinsam besser.",
          encyclopedia: "Wissensdatenbank",
          encyclopediaDesc: "Entdecke Destillerien, Regionen und Abfüller mit unserer integrierten Enzyklopädie. Recherchiere beim Verkosten.",
        },
        howItWorks: {
          title: "Drei einfache Schritte",
          subtitle: "Von der Einrichtung bis zum Genuss in unter einer Minute.",
        },
        steps: {
          create: "Tasting erstellen",
          createDesc: "Gib deiner Session einen Namen und füge Whiskys hinzu — manuell, per Tabelle oder lass die KI es für dich erledigen.",
          invite: "Freunde einladen",
          inviteDesc: "Teile einen Zugangscode oder QR-Link. Gäste treten sofort bei — kein Konto nötig.",
          taste: "Verkosten & Entdecken",
          tasteDesc: "Bewerte, diskutiere und enthülle Ergebnisse gemeinsam. Vergleiche Gaumen und entdecke, was du liebst.",
        },
        story: {
          title: "Die Geschichte hinter CaskSense",
          label: "Unsere Reise",
          p1: "CaskSense entstand aus einer einfachen Leidenschaft: großartigen Whisky mit Freunden teilen und sich an jeden Dram erinnern wollen. Was als Notizen auf Servietten begann, wuchs zum Wunsch nach einem richtigen Tool — eines, das das gesamte Erlebnis festhält, nicht nur die Punktzahl.",
          p2: "Wir glauben, dass Whisky-Tastings zugänglich, gesellig und ein bisschen magisch sein sollten. Deshalb haben wir Blind-Tasting-Support, KI-gestützten Import und ein Enthüllungssystem gebaut, das jede Session zu einem unvergesslichen Event macht.",
          p3: "Ob erfahrener Sammler oder beim Öffnen deiner ersten Flasche Single Malt — CaskSense ist dafür gemacht, dass jeder Schluck zählt. Wir sind Whisky-Liebhaber, die für Whisky-Liebhaber bauen.",
        },
        ai: {
          badge: "KI-gestützt",
          title: "Tastings aus allem importieren",
          desc: "Kein lästiges Abtippen mehr. Fotografiere deine Flaschen, lade eine Tabelle hoch, füge eine URL ein oder tippe eine Liste — die KI von CaskSense extrahiert alle Details in Sekunden.",
          bullet1: "Fotoerkennung: einfach dein Line-up fotografieren",
          bullet2: "Excel- & CSV-Import mit automatischer Spaltenzuordnung",
          bullet3: "Text oder URLs einfügen und die KI den Rest machen lassen",
          photo: "Fotos",
          file: "Tabellen",
          web: "URLs & Text",
          text: "Tasting-Listen",
        ...
        cta: {
          title: "Bereit, deine Tastings auf ein neues Level zu heben?",
          desc: "Werde Teil der CaskSense-Community und veranstalte ab heute bessere Whisky-Erlebnisse. Kostenlos nutzbar, kein Konto zum Start nötig.",
