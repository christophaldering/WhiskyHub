  ...
  en: {
    translation: {
      ...
      landing: {
        ...
        story: {
          title: "Why CaskSense exists",
          label: "Background",
          photoCaption: "Christoph & Sammy — he brings us into the here and now.",
          p1: "I'm not a software developer. In my day job, I help assess opportunities and risks around executive appointments — psychology, diagnostics, consulting. And I love whisky: for the nuances, the conversations, the memory of a good dram.",
          p2: "It started with a tasting at my neighbour and friend Rudi's place in Cologne. From that evening on, it was clear: whisky is more than a drink — it's about perception, about what happens at the table, about moments worth holding on to. And when there's an Octomore in the glass at the end of the night, sometimes no words are needed.",
          p3: "CaskSense grew out of curiosity. After a brief encounter with OpenClaw, I landed on Replit and simply wanted to try what's possible today. The speed at which working software emerged fascinated me — and made me think. Because when software appears this quickly, it changes work for many people who sit in front of screens.",
          p4: "I'm not a tech optimist on principle, nor a pessimist. I try things out, observe — and think it through afterwards. And now that I have more time: the joy of connecting the interesting with the useful.",
          p5: "CaskSense is my attempt to bring both together:",
          bullet1: "Structure that deepens perception (not replaces enjoyment)",
          bullet2: "Technology that handles routine (not fabricates impressions)",
          tagline: "If you like, it's simply a tasting tool. If you look more closely, it's also an experiment.",
        },
        ai: {
          badge: "AI-powered",
  ...
  de: {
    translation: {
      ...
      landing: {
        ...
        story: {
          title: "Warum es CaskSense gibt",
          label: "Hintergrund",
          photoCaption: "Christoph & Sammy – er holt uns ins Hier und Jetzt.",
          p1: "Ich bin kein Software-Entwickler. Im Hauptberuf helfe ich dabei, Chancen und Risiken bei Besetzungsentscheidungen einzuschätzen – vor allem auf Top-Executive-Ebene. Psychologie, Diagnostik, Beratung. Und ich liebe Whisky: wegen der Nuancen, der Gespräche, der Erinnerung an einen guten Dram.",
          p2: "Angefangen hat es mit einem Tasting bei meinem Nachbarn und Freund Rudi in Köln. Ab da war klar: Whisky ist mehr als ein Getränk – es geht um Wahrnehmung, um das, was am Tisch passiert, um die Momente, die man festhalten will. Und wenn am Ende ein Octomore im Glas ist, braucht es manchmal keine Worte mehr.",
          p3: "CaskSense ist aus Neugier entstanden. Nach einer kurzen Auseinandersetzung mit OpenClaw bin ich bei Replit gelandet und wollte ausprobieren, was heute möglich ist. Die Geschwindigkeit, mit der daraus funktionierende Software wurde, hat mich fasziniert – und nachdenklich gemacht. Denn wenn Software so schnell entsteht, verändert das die Arbeit vieler Menschen, die vor Bildschirmen sitzen.",
          p4: "Ich bin kein Technik-Optimist aus Prinzip, aber auch kein Pessimist. Ich probiere aus, beobachte – und denke danach weiter. Und jetzt, da ich mehr Zeit habe: Spaß an der Freude, das Spannende und Interessante mit dem Nützlichen zu verbinden.",
          p5: "CaskSense ist mein Versuch, beides zusammenzubringen:",
          bullet1: "Struktur, die Wahrnehmung vertieft (nicht Genuss ersetzt)",
          bullet2: "Technik, die Routine abnimmt (nicht Eindruck vorgibt)",
          tagline: "Wenn du willst, ist es einfach ein Tasting-Tool. Wenn du genauer hinschaust, ist es auch ein Experiment.",
        },
        ai: {
          badge: "KI-gestützt",
