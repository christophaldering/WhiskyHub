    ...
    translation: {
      ...
      landing: {
        ...
        features: {
          ...
          subtitle: "Structure for tasting, tools for capturing, space for discovering.",
        ...
        story: {
          ...
          label: "Background",
          p1: "I'm not a software developer. I come from psychology, diagnostics, and consulting — and I love whisky: for the nuances, the conversations, the memory of a good dram.",
          p2: "CaskSense grew out of curiosity. After a brief encounter with OpenClaw, I landed on Replit and simply wanted to try what's possible today. The speed at which working software emerged fascinated me — and made me think.",
          p3: "Because there's a second layer: when software appears this quickly, it changes work for many people who sit in front of screens. I'm not a tech optimist on principle, nor a pessimist. I try things out, observe — and think it through afterwards.",
          p4: "CaskSense is my attempt to connect both:",
    ...
    translation: {
      ...
      landing: {
        ...
        features: {
          ...
          subtitle: "Struktur fürs Verkosten, Werkzeuge fürs Festhalten, Raum fürs Entdecken.",
          blindTasting: "Blind-Tastings",
        ...
        story: {
          ...
          label: "Hintergrund",
          p1: "Ich bin kein Software-Entwickler. Ich komme aus Psychologie, Diagnostik und Beratung – und ich liebe Whisky: wegen der Nuancen, der Gespräche, der Erinnerung an einen guten Dram.",
          p2: "CaskSense ist aus Neugier entstanden. Nach einer kurzen Auseinandersetzung mit OpenClaw bin ich bei Replit gelandet und wollte einfach ausprobieren, was heute möglich ist. Die Geschwindigkeit, mit der daraus funktionierende Software wurde, hat mich fasziniert – und nachdenklich gemacht.",
          p3: "Denn das ist die zweite Ebene: Wenn Software so schnell entsteht, verändert das die Arbeit vieler Menschen, die vor Bildschirmen arbeiten. Ich bin kein Technik-Optimist aus Prinzip, aber auch kein Pessimist. Ich probiere aus, beobachte – und denke danach weiter.",
          p4: "CaskSense ist mein Versuch, beides zu verbinden:",
