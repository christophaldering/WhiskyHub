...
export default function LabsBottlers() {
  ...
  return (
    <div className="labs-page" data-testid="labs-discover-bottlers-page">
      ...
      <p style={{ fontSize: 12, color: "var(--labs-text-muted)", margin: "0 0 16px" }}>{isLoading ? t("discover.loading", "Loading...") : t("m2.discover.bottlersSubtitle", { count: bottlersList.length })}</p>
