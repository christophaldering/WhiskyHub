  ...
  return (
    <div className="labs-page labs-fade-in">
      ...
      {(!showSectionMenu || activeSection === "rueckblick") && (() => {
        ...
        return (
          <section id="section-rueckblick" className="mb-8 labs-stagger-4 labs-fade-in labs-detail-section-anchor" data-testid="detail-section-rueckblick">
      ...
      {(!showSectionMenu || activeSection === "praesentation") && (isReveal || isCompleted) && (() => {
        ...
        return (
          <section id="section-praesentation" className="mb-8 labs-fade-in labs-detail-section-anchor" data-testid="detail-section-praesentation">
      ...
      {(!showSectionMenu || activeSection === "host-aktionen") && isHost && (
        <section id="section-host-aktionen" className="mb-8 labs-fade-in labs-detail-section-anchor" data-testid="detail-section-host-aktionen">
          <header style={{ marginBottom: 12 }}>
            <h2 style={{ fontSize: 14, fontWeight: 700, color: "var(--labs-text)", margin: 0, letterSpacing: "0.02em" }}>
      ...
      {(!showSectionMenu || activeSection === "downloads") && (() => {
        ...
        return (
          <div id="section-downloads" className="mb-6 labs-detail-section-anchor" data-testid={`labs-detail-downloads-${phase}`}>
            {!showResults && (
              <p
