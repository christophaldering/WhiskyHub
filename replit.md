...
-   **My Taste (Personal Dashboard)**: Personal whisky profile hub with stats, AI insights, and links to flavor wheel, comparison, analytics, and journal.
-   **Discover (External World Hub)**: Links to community, rankings, leaderboard, activity, recommendations, lexicon, distilleries, and a whisky database.
