...
-   **CaskSense Labs (`/labs/*`)**: A parallel experimental UX layer focused on refined whisky tasting. Dedicated shell (`LabsLayout.tsx`) with warm dark premium theme (`labs-theme.css`), Apple-inspired design, bottom nav (Tastings/Explore/Taste/Circle). Reuses all existing backend APIs, auth, and database. Files: `client/src/labs/` directory.
