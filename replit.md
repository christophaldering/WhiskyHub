...
-   **Taste Tab (`/m2/taste/*`)**: Provides a personal dashboard for users, including taste snapshots, profile analytics, dram management, collection sync, comparison tools, recommendations, collection analysis, and settings.
